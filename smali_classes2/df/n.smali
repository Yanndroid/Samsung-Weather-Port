...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "viewType",
        "<init>",
        "(Lbf/a2;Landroidx/lifecycle/w;Lcom/sec/android/daemonapp/app/detail/viewmodel/DetailViewModel;Lmf/a;I)V",
...
# direct methods
.method public constructor <init>(Lbf/a2;Landroidx/lifecycle/w;Lcom/sec/android/daemonapp/app/detail/viewmodel/DetailViewModel;Lmf/a;I)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Ldf/n;->B:Lbf/a2;

    .line 3
    iput-object p3, p0, Ldf/n;->C:Lcom/sec/android/daemonapp/app/detail/viewmodel/DetailViewModel;

    .line 4
    iput-object p4, p0, Ldf/n;->D:Lmf/a;

    .line 5
    iput p5, p0, Ldf/n;->E:I

    .line 6
    invoke-virtual {p1, p3}, Lbf/a2;->o0(Lcom/sec/android/daemonapp/app/detail/viewmodel/DetailViewModel;)V
    ...
    invoke-virtual {p1, p4}, Lbf/a2;->m0(Ljava/lang/Boolean;)V
    ...
    new-instance p4, Ldf/l;

    invoke-direct {p4, p0}, Ldf/l;-><init>(Ldf/n;)V
    ...
    invoke-direct {p3, p0}, Ldf/m;-><init>(Ldf/n;)V
...
.method public static synthetic P(Ldf/n;Ljf/k;)V
    .locals 0

    invoke-static {p0, p1}, Ldf/n;->R(Ldf/n;Ljf/k;)V

    return-void
.end method

.method public static synthetic Q(Ldf/n;Ljava/lang/Float;)V
    .locals 0

    invoke-static {p0, p1}, Ldf/n;->S(Ldf/n;Ljava/lang/Float;)V

    return-void
.end method

.method public static final R(Ldf/n;Ljf/k;)V
    .locals 2
    ...
    .line 1
    iget-object v0, p0, Ldf/n;->D:Lmf/a;

    iget v1, p0, Ldf/n;->E:I

    invoke-virtual {p1}, Ljf/k;->f()Ljava/util/List;

    move-result-object p1

    invoke-virtual {v0, v1, p1}, Lmf/a;->a(ILjava/util/List;)Ljf/e;
    ...
    .line 2
    invoke-virtual {p0, p1}, Ldf/n;->T(Ljf/e;)V

    :cond_0
    return-void
.end method

.method public static final S(Ldf/n;Ljava/lang/Float;)V
    .locals 6
    ...
    .line 2
    iget-object v2, p0, Ldf/n;->B:Lbf/a2;
    ...
    .line 3
    iget-object v4, p0, Ldf/n;->B:Lbf/a2;
    ...
    iget-object v2, v2, Lbf/a2;->J:Lcom/samsung/android/weather/app/common/view/SizeLimitedTextView;
    ...
    .line 7
    iget-object v1, p0, Ldf/n;->B:Lbf/a2;
    ...
    .line 10
    iget-object p0, p0, Ldf/n;->B:Lbf/a2;

    iget-object p0, p0, Lbf/a2;->K:Lcom/samsung/android/weather/app/common/view/SizeLimitedTextView;
...
.method public final T(Ljf/e;)V
    ...
    .line 1
    iget-object v0, p0, Ldf/n;->B:Lbf/a2;

    invoke-virtual {v0, p1}, Lbf/a2;->l0(Ljf/e;)V

    .line 2
    iget-object p1, p0, Ldf/n;->B:Lbf/a2;

    iget-object v0, p0, Ldf/n;->C:Lcom/sec/android/daemonapp/app/detail/viewmodel/DetailViewModel;
    ...
    invoke-virtual {p1, v0}, Lbf/a2;->n0(Ljava/lang/Boolean;)V
