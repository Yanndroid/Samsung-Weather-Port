...
.method public static synthetic o(Lde/a;Landroid/content/Context;Ltd/h;JZZILjava/lang/Object;)Ljava/lang/String;
    .locals 7
    ...
    invoke-virtual/range {v0 .. v6}, Lde/a;->n(Landroid/content/Context;Ltd/h;JZZ)Ljava/lang/String;
...
.method public static synthetic r(Lde/a;Landroid/content/Context;Ltd/h;JZZILjava/lang/Object;)Ljava/lang/String;
    .locals 7
...
.method public final a(Ljava/util/Locale;)Z
    ...
    invoke-virtual {v0, p1, v2}, Lde/i;->a(Ljava/util/Locale;[Ljava/lang/String;)Z
...
.method public final b(Landroid/content/Context;Ltd/h;)Ljava/lang/String;
    .locals 1
    ...
    invoke-virtual {v0, p2}, Lde/i;->n(Ljava/util/Locale;)Z
    ...
    sget p2, Lyd/d;->abbrev_wday_month_day_no_year:I
    ...
    sget v0, Lyd/d;->abbrev_wday_month_day_no_year:I
...
.method public final c(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
    .locals 0
...
.method public final d(Landroid/content/Context;Ltd/h;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 1
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lde/a;->b(Landroid/content/Context;Ltd/h;)Ljava/lang/String;
...
.method public final e(Landroid/content/Context;Ltd/h;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 3
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3}, Lde/a;->d(Landroid/content/Context;Ltd/h;Ljava/util/Calendar;)Ljava/lang/String;

    move-result-object p2

    .line 3
    invoke-virtual {p0, p1, p3}, Lde/a;->j(Landroid/content/Context;Ljava/util/Calendar;)Ljava/lang/String;
    ...
    invoke-virtual {p3, v0}, Lde/i;->r(Ljava/util/Locale;)Z
...
.method public final g(Ljava/util/Calendar;)Ljava/lang/String;
    ...
    .line 1
    invoke-virtual {p0}, Lde/a;->f()Ljava/lang/String;
...
.method public final h(Landroid/content/Context;Ltd/h;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0, p3}, Lde/a;->g(Ljava/util/Calendar;)Ljava/lang/String;
    ...
    invoke-virtual {p3, p2}, Lde/i;->r(Ljava/util/Locale;)Z
...
.method public final j(Landroid/content/Context;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 4
    ...
    invoke-virtual {p0, p1, v0}, Lde/a;->i(Landroid/content/Context;Ljava/util/TimeZone;)Ljava/text/DateFormat;
...
.method public final k(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
    .locals 0
...
.method public final l(Landroid/content/Context;Ltd/h;JJLjava/lang/String;)Ljava/lang/String;
    .locals 9
...
.method public final m(Landroid/content/Context;Ltd/h;Ljava/util/Calendar;)Ljava/lang/String;
    .locals 19
    ...
    .line 1
    invoke-interface/range {p2 .. p2}, Ltd/h;->b()Ljava/util/Locale;
    ...
    .line 6
    :cond_4
    sget-object v9, Lde/i;->a:Lde/i;

    invoke-virtual {v9, v1}, Lde/i;->l(Ljava/util/Locale;)Z
    ...
    .line 7
    invoke-static {v2, v13, v10}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 9
    invoke-static {v2, v11, v9}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 12
    invoke-virtual {v9, v1}, Lde/i;->n(Ljava/util/Locale;)Z
    ...
    .line 14
    :cond_8
    invoke-virtual {v9, v1}, Lde/i;->d(Ljava/util/Locale;)Z
    ...
    .line 15
    invoke-static {v2, v13, v1}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v8, v5}, Lyj/k;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 17
    :cond_9
    invoke-static {v2, v11, v1}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 19
    :cond_a
    invoke-static {v2, v10, v1}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 22
    invoke-static {v2, v13, v15}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 24
    :cond_d
    invoke-static {v2, v11, v15}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    .line 26
    :cond_e
    invoke-static {v2, v10, v15}, Lrm/t;->q(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public final n(Landroid/content/Context;Ltd/h;JZZ)Ljava/lang/String;
    .locals 11
    ...
    .line 1
    sget v2, Lyd/d;->last_updated_tts:I
    ...
    .line 4
    invoke-virtual {p0, p1, v3}, Lde/a;->k(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p0, p1, v3}, Lde/a;->c(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
...
.method public final p(Landroid/content/Context;Ltd/h;JZZ)Ljava/lang/String;
    .locals 9
    ...
    invoke-virtual/range {v1 .. v8}, Lde/a;->q(Landroid/content/Context;Ltd/h;JZZZ)Ljava/lang/String;
...
.method public final q(Landroid/content/Context;Ltd/h;JZZZ)Ljava/lang/String;
    .locals 4

    .line 1
    sget v0, Lyd/d;->last_updated_text:I
    ...
    .line 4
    invoke-virtual {p0, p1, v1}, Lde/a;->k(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
    ...
    .line 5
    :try_start_1
    invoke-virtual {p0, p1, v1}, Lde/a;->c(Landroid/content/Context;Ljava/util/Date;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p2, p3}, Lde/i;->a(Ljava/util/Locale;[Ljava/lang/String;)Z
