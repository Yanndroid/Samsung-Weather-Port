.class Lcom/samsung/android/weather/interworking/news/domain/persistence/dao/SamsungNewsDao_Impl$4;
...
.method public constructor <init>(Lcom/samsung/android/weather/interworking/news/domain/persistence/dao/SamsungNewsDao_Impl;Landroidx/room/i0;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/interworking/news/domain/persistence/dao/SamsungNewsDao_Impl$4;->this$0:Lcom/samsung/android/weather/interworking/news/domain/persistence/dao/SamsungNewsDao_Impl;
...
.method public bridge synthetic bind(Lx2/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/weather/interworking/news/domain/persistence/dao/SamsungNewsDao_Impl$4;->bind(Lx2/i;Lcom/samsung/android/weather/interworking/news/domain/persistence/models/SamsungNewsEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE `TABLE_SAMSUNG_NEWS_INFO` SET `COL_STATUS_ID` = ?,`COL_NEWS_TITLE` = ?,`COL_NEWS_URL` = ?,`COL_NEWS_IMAGE_URL` = ?,`COL_NEWS_EDITION` = ?,`COL_NEWS_PUBLISHER` = ?,`COL_NEWS_PUBLISHER_ID` = ?,`COL_NEWS_PUBLISHER_LOGO` = ?,`COL_NEWS_THEME_COLOR` = ?,`COL_NEWS_PUBLISHED_TIME` = ?,`COL_NEWS_EXPIRED_TIME` = ?,`COL_NEWS_IS_BREAKING_NEWS` = ?,`COL_NEWS_JSON` = ?,`COL_NEWS_IS_READ` = ?,`COL_NEWS_UPDATE_DATE` = ? WHERE `COL_STATUS_ID` = ?"
