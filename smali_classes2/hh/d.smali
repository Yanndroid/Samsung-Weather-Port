...
.method public constructor <init>(Landroid/content/Context;Lgh/d;)V
    ...
    .line 2
    iput-object p1, p0, Lhh/d;->a:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Lhh/d;->b:Lgh/d;
...
.method public final a(Lpj/d;)Ljava/lang/Object;
    ...
    instance-of v0, p1, Lhh/d$a;

    if-eqz v0, :cond_0

    move-object v0, p1

    check-cast v0, Lhh/d$a;

    iget v1, v0, Lhh/d$a;->k:I
    ...
    invoke-direct {v0, p0, p1}, Lhh/d$a;-><init>(Lhh/d;Lpj/d;)V

    :goto_0
    iget-object p1, v0, Lhh/d$a;->i:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lhh/d$a;->h:Ljava/lang/Object;
    ...
    iget-object p1, p0, Lhh/d;->b:Lgh/d;

    iput-object p0, v0, Lhh/d$a;->h:Ljava/lang/Object;

    iput v3, v0, Lhh/d$a;->k:I
    ...
    const-string v4, "NormalNotification "
    ...
    iget-object v2, v0, Lhh/d;->a:Landroid/content/Context;

    const-string v4, "weather.notification.normal"
    ...
    invoke-virtual {p1, v2}, Lch/c;->b(Landroid/content/Context;)Landroid/app/PendingIntent;

    move-result-object v2

    invoke-virtual {v1, v2}, Lc0/h$d;->m(Landroid/app/PendingIntent;)Lc0/h$d;

    .line 20
    iget-object v0, v0, Lhh/d;->a:Landroid/content/Context;

    invoke-virtual {p1, v0, v3}, Lch/c;->e(Landroid/content/Context;Z)Landroid/app/PendingIntent;
