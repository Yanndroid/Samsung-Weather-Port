...
.method public constructor <init>(Lza/l;)V
    ...
    .line 2
    iput-object p1, p0, Ltb/l2;->a:Lza/l;

    return-void
.end method

.method public static final synthetic i(Ltb/l2;)Lza/l;
    .locals 0

    iget-object p0, p0, Ltb/l2;->a:Lza/l;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Ltb/l2;->j(Lcom/samsung/android/weather/domain/entity/weather/Weather;)Lcom/samsung/android/weather/domain/entity/weather/Weather;
...
.method public j(Lcom/samsung/android/weather/domain/entity/weather/Weather;)Lcom/samsung/android/weather/domain/entity/weather/Weather;
    ...
    new-instance v1, Ltb/l2$a;

    invoke-direct {v1, p1, p0}, Ltb/l2$a;-><init>(Lcom/samsung/android/weather/domain/entity/weather/Weather;Ltb/l2;)V

    invoke-virtual {p0, v0, v1}, Ltb/l2;->k(Ljava/lang/Object;Lxj/a;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/samsung/android/weather/domain/entity/content/WebContent;

    invoke-virtual {p1, v0}, Lcom/samsung/android/weather/domain/entity/weather/Weather;->x(Lcom/samsung/android/weather/domain/entity/content/WebContent;)V
    ...
    new-instance v1, Ltb/l2$b;

    invoke-direct {v1, p1, p0}, Ltb/l2$b;-><init>(Lcom/samsung/android/weather/domain/entity/weather/Weather;Ltb/l2;)V
    ...
    .line 4
    :cond_0
    invoke-virtual {p1, v0}, Lcom/samsung/android/weather/domain/entity/weather/Weather;->y(Ljava/util/List;)V
    ...
    new-instance v1, Ltb/l2$c;

    invoke-direct {v1, p1, p0}, Ltb/l2$c;-><init>(Lcom/samsung/android/weather/domain/entity/weather/Weather;Ltb/l2;)V
    ...
    .line 7
    :cond_1
    invoke-virtual {p1, v0}, Lcom/samsung/android/weather/domain/entity/weather/Weather;->u(Ljava/util/List;)V
    ...
    new-instance v1, Ltb/l2$d;

    invoke-direct {v1, p1, p0}, Ltb/l2$d;-><init>(Lcom/samsung/android/weather/domain/entity/weather/Weather;Ltb/l2;)V
