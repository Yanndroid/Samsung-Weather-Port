...
.method public synthetic constructor <init>(IZZILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 1
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lnf/a;-><init>(IZZ)V
...
.method public g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$o0;)V
    ...
    .line 1
    iget-boolean p4, p0, Lnf/a;->c:Z

    if-eqz p4, :cond_0

    .line 2
    iget p4, p0, Lnf/a;->a:I
    ...
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$q;->k()I
    ...
    .line 5
    iget-boolean p2, p0, Lnf/a;->b:Z

    if-eqz p2, :cond_4

    .line 6
    iget p2, p0, Lnf/a;->a:I
