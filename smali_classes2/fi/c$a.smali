...
.method public a(Ljava/lang/reflect/Type;Ljava/util/Set;Lfi/t;)Lfi/f;
    ...
    .line 5
    :cond_2
    invoke-static {v0}, Lgi/c;->i(Ljava/lang/Class;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lfi/c$a;->d(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    .line 20
    invoke-static {v0}, Lgi/c;->h(Ljava/lang/Class;)Z
    ...
    .line 21
    invoke-static {v0}, Lfi/b;->a(Ljava/lang/Class;)Lfi/b;
    ...
    .line 24
    invoke-virtual {p0, p3, p1, v0}, Lfi/c$a;->b(Lfi/t;Ljava/lang/reflect/Type;Ljava/util/Map;)V

    .line 25
    invoke-static {p1}, Lfi/w;->f(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {p1, p2, v0}, Lfi/c;-><init>(Lfi/b;Ljava/util/Map;)V
...
.method public final b(Lfi/t;Ljava/lang/reflect/Type;Ljava/util/Map;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p2}, Lfi/w;->g(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    invoke-virtual {p0, v1, v6}, Lfi/c$a;->c(ZI)Z
    ...
    .line 6
    invoke-interface {v6}, Lfi/e;->ignore()Z
    ...
    invoke-static {p2, v0, v7}, Lgi/c;->p(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v7

    .line 8
    invoke-static {v5}, Lgi/c;->j(Ljava/lang/reflect/AnnotatedElement;)Ljava/util/Set;
    ...
    .line 10
    invoke-virtual {p1, v7, v8, v9}, Lfi/t;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lfi/f;
    ...
    .line 12
    invoke-static {v9, v6}, Lgi/c;->l(Ljava/lang/String;Lfi/e;)Ljava/lang/String;
    ...
    invoke-direct {v8, v6, v5, v7}, Lfi/c$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Lfi/f;)V
    ...
    iget-object p3, v5, Lfi/c$b;->b:Ljava/lang/reflect/Field;
    ...
    iget-object p3, v8, Lfi/c$b;->b:Ljava/lang/reflect/Field;
