...
.method public constructor <init>(Lxh/a;Lsg/b;)V
    ...
    .line 2
    iput-object p1, p0, Llg/b;->a:Lxh/a;

    .line 3
    iput-object p2, p0, Llg/b;->b:Lsg/b;
...
.method public c(Landroid/content/Context;ZZ)Landroid/widget/RemoteViews;
    ...
    sget p3, Lyh/g;->cover_widget_empty_layout:I

    invoke-direct {p2, p1, p3}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    .line 2
    sget p1, Lyh/e;->cover_widget_hourly_horizontal_empty:I

    .line 3
    iget-object p3, p0, Llg/b;->b:Lsg/b;

    invoke-virtual {p0}, Llg/b;->d()Lxh/a;
    ...
    invoke-interface {p3, v0}, Lsg/b;->p(I)Landroid/app/PendingIntent;
    ...
    .line 5
    sget p1, Lyh/e;->cover_widget_hourly_vertical_empty:I
...
.method public d()Lxh/a;
    ...
    iget-object v0, p0, Llg/b;->a:Lxh/a;
