...
.method public constructor <init>(Lcd/w;Lw1/n0;)V
    ...
    iput-object p1, p0, Lcd/w$b;->d:Lcd/w;
...
.method public e()Ljava/lang/String;
    ...
    const-string v0, "UPDATE `TABLE_WIDGET_INFO` SET `COL_WIDGET_ID` = ?,`COL_WEATHER_KEY` = ?,`COL_WIDGET_BACKGROUND_COLOR` = ?,`COL_WIDGET_BACKGROUND_TRANSPARENCY` = ?,`COL_WIDGET_NIGHT_MODE` = ?,`COL_WIDGET_RESTORE_MODE` = ?,`COL_WIDGET_ADDED_IN_DCM_LAUNCHER` = ?,`COL_WIDGET_SHOW_NEWS` = ? WHERE `COL_WIDGET_ID` = ?"
...
.method public bridge synthetic i(Lb2/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcd/w$b;->k(Lb2/k;Led/d;)V

    return-void
.end method

.method public k(Lb2/k;Led/d;)V
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 20
    :goto_5
    iget-object v0, p2, Led/d;->h:Ljava/lang/Integer;
