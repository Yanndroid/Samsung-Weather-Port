...
.source "CoverFaceModelRestore.kt"
...
.method public constructor <init>(Lxh/a;Lsg/b;)V
    ...
    .line 2
    iput-object p1, p0, Lmg/e;->a:Lxh/a;

    .line 3
    iput-object p2, p0, Lmg/e;->b:Lsg/b;
...
.method public c(Landroid/content/Context;ZZ)Landroid/widget/RemoteViews;
    ...
    sget v0, Lyh/g;->cover_face_widget_restore_layout:I

    invoke-direct {p2, p3, v0}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    .line 2
    invoke-virtual {p0, p2, p1}, Lmg/e;->d(Landroid/widget/RemoteViews;Landroid/content/Context;)V

    .line 3
    sget p1, Lyh/e;->cover_widget_index_restore:I

    .line 4
    iget-object p3, p0, Lmg/e;->b:Lsg/b;

    invoke-virtual {p0}, Lmg/e;->e()Lxh/a;
...
.method public e()Lxh/a;
    ...
    iget-object v0, p0, Lmg/e;->a:Lxh/a;
