...
# instance fields
.field public final g:Lok/j0;

.field public final h:Ljava/lang/String;

.field public final i:Lnl/c;


# direct methods
.method public constructor <init>(Lok/j0;Lil/l;Lkl/c;Lkl/a;Ldm/f;Lbm/j;Ljava/lang/String;Lxj/a;)V
    .locals 16
    ...
    .line 1
    new-instance v10, Lkl/g;

    invoke-virtual/range {p2 .. p2}, Lil/l;->X()Lil/t;
    ...
    invoke-direct {v10, v0}, Lkl/g;-><init>(Lil/t;)V

    .line 2
    sget-object v0, Lkl/h;->b:Lkl/h$a;

    invoke-virtual/range {p2 .. p2}, Lil/l;->Y()Lil/w;
    ...
    invoke-virtual {v0, v7}, Lkl/h$a;->a(Lil/w;)Lkl/h;
    ...
    .line 3
    invoke-virtual/range {v7 .. v13}, Lbm/j;->a(Lok/j0;Lkl/c;Lkl/g;Lkl/h;Lkl/a;Ldm/f;)Lbm/l;

    move-result-object v2

    .line 4
    invoke-virtual/range {p2 .. p2}, Lil/l;->Q()Ljava/util/List;
    ...
    invoke-virtual/range {p2 .. p2}, Lil/l;->T()Ljava/util/List;
    ...
    invoke-virtual/range {p2 .. p2}, Lil/l;->W()Ljava/util/List;
    ...
    .line 5
    invoke-direct/range {v0 .. v5}, Ldm/h;-><init>(Lbm/l;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lxj/a;)V

    .line 6
    iput-object v14, v6, Ldm/i;->g:Lok/j0;

    .line 7
    iput-object v15, v6, Ldm/i;->h:Ljava/lang/String;

    .line 8
    invoke-interface/range {p1 .. p1}, Lok/j0;->d()Lnl/c;

    move-result-object v0

    iput-object v0, v6, Ldm/i;->i:Lnl/c;
...
.method public A(Lnl/f;Lwk/b;)V
    ...
    iget-object v1, p0, Ldm/i;->g:Lok/j0;
...
.method public f(Lnl/f;Lwk/b;)Lok/h;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Ldm/i;->A(Lnl/f;Lwk/b;)V
...
.method public bridge synthetic g(Lyl/d;Lxj/l;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, p1, p2}, Ldm/i;->z(Lyl/d;Lxj/l;)Ljava/util/List;
...
.method public n(Lnl/f;)Lnl/b;
    ...
    iget-object v1, p0, Ldm/i;->i:Lnl/c;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Ldm/i;->h:Ljava/lang/String;
...
.method public x(Lnl/f;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Ldm/h;->x(Lnl/f;)Z
    ...
    invoke-virtual {v0}, Lbm/j;->k()Ljava/lang/Iterable;
    ...
    .line 4
    iget-object v4, p0, Ldm/i;->i:Lnl/c;

    invoke-interface {v3, v4, p1}, Lqk/b;->a(Lnl/c;Lnl/f;)Z
...
.method public z(Lyl/d;Lxj/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, p2, v0}, Ldm/h;->k(Lyl/d;Lxj/l;Lwk/b;)Ljava/util/Collection;
    ...
    invoke-virtual {p2}, Lbm/j;->k()Ljava/lang/Iterable;
    ...
    .line 6
    iget-object v2, p0, Ldm/i;->i:Lnl/c;

    invoke-interface {v1, v2}, Lqk/b;->c(Lnl/c;)Ljava/util/Collection;
    ...
    .line 8
    :cond_0
    invoke-static {p1, v0}, Lmj/z;->s0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
