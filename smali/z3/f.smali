...
.method public bridge synthetic a(Ljava/lang/Object;IILo3/h;)Lq3/v;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lz3/f;->c(Landroid/net/Uri;IILo3/h;)Lq3/v;
...
.method public bridge synthetic b(Ljava/lang/Object;Lo3/h;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lz3/f;->h(Landroid/net/Uri;Lo3/h;)Z
...
.method public c(Landroid/net/Uri;IILo3/h;)Lq3/v;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Lz3/f;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p3

    .line 3
    invoke-virtual {p0, p3, p1}, Lz3/f;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 4
    sget-object v0, Lz3/f;->b:Lo3/g;
    ...
    .line 6
    invoke-static {p2, v0}, Lj4/k;->a(ZLjava/lang/String;)V

    if-nez p4, :cond_2

    .line 7
    iget-object p2, p0, Lz3/f;->a:Landroid/content/Context;

    invoke-static {p2, p3, p1}, Lz3/b;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p2, p1, p4}, Lz3/b;->a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 1
    iget-object v0, p0, Lz3/f;->a:Landroid/content/Context;
    ...
    .line 2
    iget-object p1, p0, Lz3/f;->a:Landroid/content/Context;
    ...
    .line 4
    iget-object v1, p0, Lz3/f;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Lz3/f;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 5
    invoke-virtual {p0, p2}, Lz3/f;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lo3/h;)Z
    .locals 0
