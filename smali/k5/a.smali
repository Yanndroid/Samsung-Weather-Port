...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLs4/d;Landroid/os/Bundle;Lp4/f$a;Lp4/f$b;)V
    .locals 7
    ...
    .line 1
    invoke-direct/range {v0 .. v6}, Ls4/e;-><init>(Landroid/content/Context;Landroid/os/Looper;ILs4/d;Lp4/f$a;Lp4/f$b;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lk5/a;->I:Z

    iput-object p4, p0, Lk5/a;->J:Ls4/d;

    iput-object p5, p0, Lk5/a;->K:Landroid/os/Bundle;

    .line 2
    invoke-virtual {p4}, Ls4/d;->g()Ljava/lang/Integer;

    move-result-object p1

    iput-object p1, p0, Lk5/a;->L:Ljava/lang/Integer;

    return-void
.end method

.method public static j0(Ls4/d;)Landroid/os/Bundle;
    .locals 4

    .line 1
    invoke-virtual {p0}, Ls4/d;->f()Lj5/a;

    .line 2
    invoke-virtual {p0}, Ls4/d;->g()Ljava/lang/Integer;
    ...
    .line 4
    invoke-virtual {p0}, Ls4/d;->a()Landroid/accounts/Account;
...
.method public final g(Lk5/e;)V
    ...
    :try_start_0
    iget-object v2, p0, Lk5/a;->J:Ls4/d;

    .line 2
    invoke-virtual {v2}, Ls4/d;->b()Landroid/accounts/Account;
    ...
    invoke-static {v3}, Lm4/b;->a(Landroid/content/Context;)Lm4/b;

    move-result-object v3

    invoke-virtual {v3}, Lm4/b;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    iget-object v5, p0, Lk5/a;->L:Ljava/lang/Integer;
    ...
    .line 6
    invoke-virtual {p0}, Ls4/c;->C()Landroid/os/IInterface;
    ...
    .line 8
    invoke-virtual {v2, v3, p1}, Lk5/f;->z(Lcom/google/android/gms/signin/internal/zai;Lk5/e;)V
    :try_end_0
    ...
    .line 13
    invoke-interface {p1, v4}, Lk5/e;->i(Lcom/google/android/gms/signin/internal/zak;)V
    :try_end_1
...
.method public final p()V
    ...
    invoke-direct {v0, p0}, Ls4/c$d;-><init>(Ls4/c;)V

    invoke-virtual {p0, v0}, Ls4/c;->f(Ls4/c$c;)V
...
.method public final synthetic r(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    invoke-direct {v0, p1}, Lk5/f;-><init>(Landroid/os/IBinder;)V
...
.method public final z()Landroid/os/Bundle;
    ...
    .line 1
    iget-object v0, p0, Lk5/a;->J:Ls4/d;

    invoke-virtual {v0}, Ls4/d;->d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lk5/a;->K:Landroid/os/Bundle;

    iget-object v1, p0, Lk5/a;->J:Ls4/d;
