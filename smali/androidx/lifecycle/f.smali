...
# direct methods
.method public constructor <init>(Lpj/g;JLxj/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Ltm/o2;->a(Ltm/t1;)Ltm/w;
    ...
    invoke-virtual {v1}, Ltm/e2;->d0()Ltm/e2;

    move-result-object v1

    invoke-virtual {v1, p1}, Lpj/a;->g(Lpj/g;)Lpj/g;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/c;-><init>(Landroidx/lifecycle/f;Lxj/p;JLtm/j0;Lxj/a;)V
...
.method public final q(Lpj/d;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/f$b;-><init>(Landroidx/lifecycle/f;Lpj/d;)V
