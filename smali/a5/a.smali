...
.field public static volatile c:La5/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, La5/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, La5/a;->f(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, La5/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, La5/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, La5/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 5
    :cond_0
    invoke-static {p1, p2}, La5/a;->d(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual/range {v0 .. v7}, La5/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 4
    :try_start_0
    invoke-static {p1}, Lc5/c;->a(Landroid/content/Context;)Lc5/b;

    move-result-object v2

    invoke-virtual {v2, p6, v1}, Lc5/b;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, La5/a;->f(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, La5/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, La5/a;->g(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 14
    iget-object p2, p0, La5/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
