...
.method public static synthetic a(Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;Ljava/util/List;Lti/l;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;->lambda$getStatusSingleSubscribe$1(Ljava/util/List;Lti/l;)V
...
.method public static synthetic f(Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;Ljava/util/ArrayList;Ljava/util/List;Lti/l;ZLjava/lang/String;Ljava/util/Map;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;->lambda$moldDeviceStatusListener$3(Ljava/util/ArrayList;Ljava/util/List;Lti/l;ZLjava/lang/String;Ljava/util/Map;)V

    return-void
.end method

.method private getStatusSingleSubscribe(Ljava/util/List;)Lti/n;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private synthetic lambda$getStatusSingleSubscribe$1(Ljava/util/List;Lti/l;)V
    .locals 2
    ...
    .line 3
    invoke-virtual {p0, p2, v1, v0}, Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;->moldDeviceStatusListener(Lti/l;Ljava/util/ArrayList;Ljava/util/List;)Lcom/samsung/android/sdk/stkit/listener/DeviceStatusListener;
...
.method private synthetic lambda$moldDeviceStatusListener$3(Ljava/util/ArrayList;Ljava/util/List;Lti/l;ZLjava/lang/String;Ljava/util/Map;)V
    .locals 0
    ...
    .line 5
    invoke-interface {p3, p2}, Lti/l;->b(Ljava/lang/Object;)V
...
.method public abstract controlAirPurifier(Lcom/samsung/android/sdk/stkit/api/weather/AirPurifierControl;)Lti/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public convertDataToAirQualityDetectorType(Ljava/util/Map;)Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDevice;
    ...
    sget-object v7, Lcom/samsung/android/sdk/stkit/api/weather/d;->h:Lcom/samsung/android/sdk/stkit/api/weather/d;
...
.method public moldDeviceStatusListener(Lti/l;Ljava/util/ArrayList;Ljava/util/List;)Lcom/samsung/android/sdk/stkit/listener/DeviceStatusListener;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2, p3, p1}, Lcom/samsung/android/sdk/stkit/api/weather/a;-><init>(Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;Ljava/util/ArrayList;Ljava/util/List;Lti/l;)V
...
.method public requestCurrentStatus(Ljava/util/List;)Lti/k;
    ...
    invoke-direct {p0, p1}, Lcom/samsung/android/sdk/stkit/api/weather/AirQualityDeviceMonitor;->getStatusSingleSubscribe(Ljava/util/List;)Lti/n;

    move-result-object p1

    invoke-static {p1}, Lti/k;->b(Lti/n;)Lti/k;
...
.method public abstract startSubscribingStatus(Ljava/util/List;)Lti/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
