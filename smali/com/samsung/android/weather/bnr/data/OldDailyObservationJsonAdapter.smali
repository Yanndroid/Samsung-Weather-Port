...
# instance fields
.field private final oldNightConditionAdapter:Lfi/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lfi/f<",
...
.field private final oldObservationPAdapter:Lfi/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lfi/f<",
...
.method public constructor <init>(Lfi/t;)V
    ...
    iput-object v2, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->options:Lfi/k$b;

    .line 3
    const-class v2, Lcom/samsung/android/weather/bnr/data/OldNightCondition;
    ...
    iput-object v0, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->oldNightConditionAdapter:Lfi/f;
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->oldObservationPAdapter:Lfi/f;
...
# virtual methods
.method public fromJson(Lfi/k;)Lcom/samsung/android/weather/bnr/data/OldDailyObservation;
    .locals 6
    ...
    .line 4
    iget-object v2, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->options:Lfi/k$b;

    invoke-virtual {p1, v2}, Lfi/k;->S(Lfi/k$b;)I
    ...
    .line 5
    :cond_0
    iget-object v1, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->oldObservationPAdapter:Lfi/f;
    ...
    :cond_1
    invoke-static {v3, v3, p1}, Lgi/c;->v(Ljava/lang/String;Ljava/lang/String;Lfi/k;)Lfi/h;
    ...
    .line 6
    :cond_2
    iget-object v0, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->oldNightConditionAdapter:Lfi/f;
    ...
    :cond_3
    invoke-static {v4, v4, p1}, Lgi/c;->v(Ljava/lang/String;Ljava/lang/String;Lfi/k;)Lfi/h;
    ...
    invoke-direct {v2, v0, v1}, Lcom/samsung/android/weather/bnr/data/OldDailyObservation;-><init>(Lcom/samsung/android/weather/bnr/data/OldNightCondition;Lcom/samsung/android/weather/bnr/data/OldObservationP;)V

    return-object v2

    .line 11
    :cond_6
    invoke-static {v3, v3, p1}, Lgi/c;->n(Ljava/lang/String;Ljava/lang/String;Lfi/k;)Lfi/h;
    ...
    .line 12
    :cond_7
    invoke-static {v4, v4, p1}, Lgi/c;->n(Ljava/lang/String;Ljava/lang/String;Lfi/k;)Lfi/h;
...
.method public bridge synthetic fromJson(Lfi/k;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->fromJson(Lfi/k;)Lcom/samsung/android/weather/bnr/data/OldDailyObservation;
...
.method public toJson(Lfi/q;Lcom/samsung/android/weather/bnr/data/OldDailyObservation;)V
    .locals 2
    ...
    .line 7
    iget-object v0, p0, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->oldObservationPAdapter:Lfi/f;
...
.method public bridge synthetic toJson(Lfi/q;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/weather/bnr/data/OldDailyObservationJsonAdapter;->toJson(Lfi/q;Lcom/samsung/android/weather/bnr/data/OldDailyObservation;)V
