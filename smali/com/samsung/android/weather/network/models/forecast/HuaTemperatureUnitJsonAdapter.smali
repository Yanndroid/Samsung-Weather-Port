...
.field private final huaUnitAdapter:Lh9/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh9/n;"
        }
...
.method public constructor <init>(Lh9/h0;)V
    ...
    iput-object v0, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->options:Lh9/q;

    sget-object v0, Lka/t;->a:Lka/t;

    const-string v1, "minimum"

    const-class v3, Lcom/samsung/android/weather/network/models/forecast/HuaUnit;

    invoke-virtual {p1, v3, v0, v1}, Lh9/h0;->c(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lh9/n;

    move-result-object v1

    iput-object v1, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->huaUnitAdapter:Lh9/n;
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->booleanAdapter:Lh9/n;
...
# virtual methods
.method public fromJson(Lh9/s;)Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;
    .locals 11
    ...
    .line 4
    iget-object v6, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->options:Lh9/q;
    ...
    .line 5
    :cond_0
    iget-object v5, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->booleanAdapter:Lh9/n;
    ...
    .line 6
    :cond_2
    iget-object v4, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->huaUnitAdapter:Lh9/n;
    ...
    .line 7
    :cond_4
    iget-object v3, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->huaUnitAdapter:Lh9/n;
    ...
    const-string p1, "null cannot be cast to non-null type com.samsung.android.weather.network.models.forecast.HuaUnit"
    ...
    .line 14
    invoke-direct {p0, v3, v4}, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;-><init>(Lcom/samsung/android/weather/network/models/forecast/HuaUnit;Lcom/samsung/android/weather/network/models/forecast/HuaUnit;)V
    ...
    .line 16
    const-class v10, Lcom/samsung/android/weather/network/models/forecast/HuaUnit;
    ...
    .line 18
    const-class v10, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;
    ...
    const-string p0, "HuaTemperatureUnit::clas\u2026his.constructorRef = it }"
    ...
    check-cast p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;
...
.method public bridge synthetic fromJson(Lh9/s;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->fromJson(Lh9/s;)Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;
...
.method public toJson(Lh9/y;Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;)V
    .locals 2
    ...
    .line 4
    iget-object v0, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->huaUnitAdapter:Lh9/n;
    ...
    .line 8
    iget-object p0, p0, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->booleanAdapter:Lh9/n;
...
.method public bridge synthetic toJson(Lh9/y;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnitJsonAdapter;->toJson(Lh9/y;Lcom/samsung/android/weather/network/models/forecast/HuaTemperatureUnit;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "GeneratedJsonAdapter(HuaTemperatureUnit)"
