.class Lcom/samsung/android/weather/persistence/database/dao/InsightContentDao_Impl$4;
...
.method public constructor <init>(Lcom/samsung/android/weather/persistence/database/dao/InsightContentDao_Impl;Landroidx/room/i0;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/persistence/database/dao/InsightContentDao_Impl$4;->this$0:Lcom/samsung/android/weather/persistence/database/dao/InsightContentDao_Impl;
...
.method public bridge synthetic bind(Lx2/i;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/weather/persistence/database/dao/InsightContentDao_Impl$4;->bind(Lx2/i;Lcom/samsung/android/weather/persistence/database/models/forecast/InsightContentEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE `TABLE_INSIGHT_CONTENT_INFO` SET `COL_WEATHER_KEY` = ?,`COL_INSIGHT_TYPE` = ?,`COL_INSIGHT_ORDER` = ?,`COL_SHOW_NOTIFICATION` = ?,`COL_SHOW_WIDGET` = ?,`COL_SHOW_DETAIL` = ?,`COL_INSIGHT_TITLE` = ?,`COL_INSIGHT_TEXT` = ?,`COL_INSIGHT_SHORT_TEXT` = ?,`COL_INSIGHT_URL` = ?,`COL_INSIGHT_TIME_DESCRIPTION` = ?,`COL_INSIGHT_SERIALIZED_JSON` = ? WHERE `COL_WEATHER_KEY` = ? AND `COL_INSIGHT_ORDER` = ?"
