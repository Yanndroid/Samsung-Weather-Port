.class public final Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl$migrate850to920$1;
.super Lt2/b;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;->migrate850to920()Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl$migrate850to920$1;
.end annotation
...
.method public constructor <init>(Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl$migrate850to920$1;->this$0:Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;
...
.method public migrate(Lx2/b;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl$migrate850to920$1;->this$0:Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;

    iget v1, p0, Lt2/b;->endVersion:I

    invoke-virtual {v0, v1}, Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;->createQueries(I)Ljava/util/List;
    ...
    invoke-virtual {v2, v3, v1}, Lcom/samsung/android/weather/infrastructure/debug/SLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/samsung/android/weather/persistence/database/migration/SettingMigration;->migrate850to920(Lx2/b;)V

    iget-object p0, p0, Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl$migrate850to920$1;->this$0:Lcom/samsung/android/weather/persistence/database/migration/WeatherMigrationImpl;
    ...
    invoke-interface {p0, p1}, Lcom/samsung/android/weather/persistence/database/migration/ForecastMigration;->migrate850to920(Lx2/b;)V
