...
# static fields
.field public static final n:Lbc/k0;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lbc/k0;->o:Lbc/a;

    new-instance v0, Lbc/k0;

    invoke-direct {v0}, Lbc/k0;-><init>()V

    sput-object v0, Lbc/k0;->n:Lbc/k0;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lbc/k0;->k:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lbc/k0;->l:B

    .line 8
    iput v0, p0, Lbc/k0;->m:I

    .line 9
    sget-object v0, Lhc/f;->a:Lhc/x;

    iput-object v0, p0, Lbc/k0;->a:Lhc/f;
...
.method public constructor <init>(Lhc/g;Lhc/j;)V
    ...
    iput-object v0, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    iput-object v5, p0, Lbc/k0;->k:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    .line 19
    :cond_2
    iget-object v5, p0, Lbc/k0;->k:Ljava/util/List;

    sget-object v6, Lbc/j0;->r:Lbc/a;
    ...
    .line 26
    iget-object p2, p0, Lbc/k0;->k:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    iput-object p2, p0, Lbc/k0;->a:Lhc/f;
    ...
    .line 32
    iget-object p1, p0, Lbc/k0;->k:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    iput-object p1, p0, Lbc/k0;->a:Lhc/f;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    check-cast v3, Lbc/j0;

    invoke-virtual {v3}, Lbc/j0;->b()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lbc/k0;->l:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lbc/k0;->a:Lhc/f;
...
.method public final f(Lhc/h;)V
    ...
    invoke-virtual {p0}, Lbc/k0;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lbc/k0;->k:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lbc/k0;->a:Lhc/f;
