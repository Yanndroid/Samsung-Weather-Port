...
# static fields
.field public static final n:Lbc/n;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lbc/n;->o:Lbc/a;

    new-instance v0, Lbc/n;

    invoke-direct {v0}, Lbc/n;-><init>()V

    sput-object v0, Lbc/n;->n:Lbc/n;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lbc/n;->k:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, Lbc/n;->l:B

    .line 8
    iput v0, p0, Lbc/n;->m:I

    .line 9
    sget-object v0, Lhc/f;->a:Lhc/x;

    iput-object v0, p0, Lbc/n;->a:Lhc/f;
...
.method public constructor <init>(Lhc/g;Lhc/j;)V
    ...
    iput-object v0, p0, Lbc/n;->k:Ljava/util/List;
    ...
    iput-object v5, p0, Lbc/n;->k:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    .line 19
    :cond_2
    iget-object v5, p0, Lbc/n;->k:Ljava/util/List;

    sget-object v6, Lbc/r;->s:Lbc/a;
    ...
    .line 26
    iget-object p2, p0, Lbc/n;->k:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lbc/n;->k:Ljava/util/List;
    ...
    iput-object p2, p0, Lbc/n;->a:Lhc/f;
    ...
    .line 32
    iget-object p1, p0, Lbc/n;->k:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lbc/n;->k:Ljava/util/List;
    ...
    iput-object p1, p0, Lbc/n;->a:Lhc/f;
...
.method public final b()Z
    ...
    :goto_0
    iget-object v3, p0, Lbc/n;->k:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lbc/r;->b()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lbc/n;->l:B
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, Lbc/n;->k:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lbc/n;->a:Lhc/f;
...
.method public final f(Lhc/h;)V
    ...
    invoke-virtual {p0}, Lbc/n;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lbc/n;->k:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lbc/n;->a:Lhc/f;
