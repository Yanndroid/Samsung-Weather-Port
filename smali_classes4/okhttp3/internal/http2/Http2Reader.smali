...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p1, p2, p3}, Lo0/a;->k(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lv8/b;->e1(II)Lya/e;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lv8/b;->a1(Lya/e;I)Lya/c;

    move-result-object p2

    iget v1, p2, Lya/c;->a:I

    iget v2, p2, Lya/c;->k:I

    iget p2, p2, Lya/c;->l:I
