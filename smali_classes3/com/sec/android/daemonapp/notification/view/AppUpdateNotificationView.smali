.class public final Lcom/sec/android/daemonapp/notification/view/AppUpdateNotificationView;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/sec/android/daemonapp/notification/view/AppUpdateNotificationView;->context:Landroid/content/Context;
...
.method public final getContext()Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/notification/view/AppUpdateNotificationView;->context:Landroid/content/Context;
...
.method public final invoke()Landroid/app/Notification;
    ...
    iget-object v1, p0, Lcom/sec/android/daemonapp/notification/view/AppUpdateNotificationView;->context:Landroid/content/Context;

    const-string v2, "weather.notification.appupdate"

    invoke-direct {v0, v1, v2}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sget v1, Lcom/sec/android/daemonapp/widget/R$drawable;->dev_opts_notify_weather:I
    ...
    sget v2, Lcom/sec/android/daemonapp/widget/R$string;->app_update_dialog_message:I

    invoke-virtual {v1, v2}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v1

    const-string v2, "context.getString(R.stri\u2026pp_update_dialog_message)"
    ...
    iget-object v4, p0, Lcom/sec/android/daemonapp/notification/view/AppUpdateNotificationView;->context:Landroid/content/Context;
    ...
    invoke-virtual {v1, p0}, Lcom/sec/android/daemonapp/notification/NotificationIntentHelper;->getSamsungAppsIntent(Landroid/content/Context;)Landroid/app/PendingIntent;
