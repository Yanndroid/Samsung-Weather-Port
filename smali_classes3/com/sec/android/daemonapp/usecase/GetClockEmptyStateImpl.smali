.class public final Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lcom/sec/android/daemonapp/usecase/GetClockEmptyState;
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/weather/system/service/SystemService;Lcom/sec/android/daemonapp/common/appwidget/AppWidgetIntent;Lcom/samsung/android/weather/domain/ForecastProviderManager;Lcom/sec/android/daemonapp/usecase/GetWidgetSettingState;)V
    ...
    iput-object p1, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->context:Landroid/content/Context;

    iput-object p2, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->systemService:Lcom/samsung/android/weather/system/service/SystemService;

    iput-object p3, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->widgetIntent:Lcom/sec/android/daemonapp/common/appwidget/AppWidgetIntent;

    iput-object p4, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->forecastProviderManager:Lcom/samsung/android/weather/domain/ForecastProviderManager;

    iput-object p5, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->getWidgetSettingState:Lcom/sec/android/daemonapp/usecase/GetWidgetSettingState;
...
.method private final getDateFormat()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->systemService:Lcom/samsung/android/weather/system/service/SystemService;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->context:Landroid/content/Context;
...
.method public invoke(ILna/d;)Ljava/lang/Object;
    ...
    instance-of v0, p2, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;

    iget v1, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->label:I
    ...
    iput v1, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;

    invoke-direct {v0, p0, p2}, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;-><init>(Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;Lna/d;)V

    :goto_0
    iget-object p2, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->result:Ljava/lang/Object;

    sget-object v1, Loa/a;->a:Loa/a;

    .line 2
    iget v2, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->label:I
    ...
    iget-object p0, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->L$0:Ljava/lang/Object;
    ...
    .line 3
    new-instance p2, Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$ClockEmpty;
    ...
    iget-object v4, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->systemService:Lcom/samsung/android/weather/system/service/SystemService;
    ...
    .line 7
    invoke-direct {p0}, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->getDateFormat()Ljava/lang/String;

    move-result-object v8

    .line 8
    iget-object v4, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->widgetIntent:Lcom/sec/android/daemonapp/common/appwidget/AppWidgetIntent;

    invoke-virtual {v4, p1}, Lcom/sec/android/daemonapp/common/appwidget/AppWidgetIntent;->getEmptyIntent(I)Landroid/app/PendingIntent;

    move-result-object v9

    .line 9
    iget-object v4, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->forecastProviderManager:Lcom/samsung/android/weather/domain/ForecastProviderManager;
    ...
    .line 11
    invoke-direct/range {v4 .. v10}, Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$ClockEmpty;-><init>(Ljava/lang/String;ZZLjava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;)V

    .line 12
    iget-object p0, p0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->getWidgetSettingState:Lcom/sec/android/daemonapp/usecase/GetWidgetSettingState;
    ...
    .line 14
    iput-object p2, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->L$0:Ljava/lang/Object;

    iput v3, v0, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl$invoke$1;->label:I
...
.method public bridge synthetic invoke(Ljava/lang/Object;Lna/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/daemonapp/usecase/GetClockEmptyStateImpl;->invoke(ILna/d;)Ljava/lang/Object;
