.class public final Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;",
...
.method public constructor <init>(Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$Restore;Lcom/sec/android/daemonapp/store/state/sub/WidgetSettingState;)V
    ...
    iput-object p1, p0, Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;->viewState:Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$Restore;

    iput-object p2, p0, Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;->settingState:Lcom/sec/android/daemonapp/store/state/sub/WidgetSettingState;
...
.method public decorate(Landroid/content/Context;)Landroid/widget/RemoteViews;
    ...
    sget v1, Lcom/sec/android/daemonapp/widget/R$layout;->cover_face_widget_restore_layout:I

    invoke-direct {v0, p1, v1}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    sget p1, Lcom/sec/android/daemonapp/widget/R$id;->cover_widget_index_restore:I

    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;->viewState:Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$Restore;
...
.method public final getSettingState()Lcom/sec/android/daemonapp/store/state/sub/WidgetSettingState;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/model/coverface/CoverFaceModelRestore;->settingState:Lcom/sec/android/daemonapp/store/state/sub/WidgetSettingState;

    return-object p0
.end method

.method public final getViewState()Lcom/sec/android/daemonapp/store/state/sub/WidgetViewState$Restore;
    .locals 0
