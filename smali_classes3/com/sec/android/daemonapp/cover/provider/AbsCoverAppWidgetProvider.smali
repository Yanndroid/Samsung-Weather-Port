.class public abstract Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;
.super Lcom/sec/android/daemonapp/cover/provider/Hilt_AbsCoverAppWidgetProvider;
.source "SourceFile"
...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lcom/sec/android/daemonapp/cover/provider/Hilt_AbsCoverAppWidgetProvider;-><init>()V
...
.method public final getRemoteViewModel()Lcom/sec/android/daemonapp/store/FavoriteRemoteViewModel;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->remoteViewModel:Lcom/sec/android/daemonapp/store/FavoriteRemoteViewModel;
...
.method public final getUpdateWidgetCount()Lcom/sec/android/daemonapp/usecase/UpdateWidgetCount;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->updateWidgetCount:Lcom/sec/android/daemonapp/usecase/UpdateWidgetCount;
...
.method public final getWidgetRepo()Lcom/samsung/android/weather/domain/repo/WidgetRepo;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->widgetRepo:Lcom/samsung/android/weather/domain/repo/WidgetRepo;
...
.method public final getWidgetTracking()Lcom/samsung/android/weather/logger/analytics/tracking/WidgetTracking;
    ...
    iget-object p0, p0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->widgetTracking:Lcom/samsung/android/weather/logger/analytics/tracking/WidgetTracking;
...
.method public onAppWidgetOptionsChanged(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;ILandroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->getRemoteViewModel()Lcom/sec/android/daemonapp/store/FavoriteRemoteViewModel;

    move-result-object p0

    invoke-virtual {p0, p3}, Lcom/sec/android/daemonapp/store/FavoriteRemoteViewModel;->onAppWidgetUpdate(I)V
    :try_end_0
...
.method public onDeleted(Landroid/content/Context;[I)V
    ...
    invoke-virtual {p0}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->getWidgetTracking()Lcom/samsung/android/weather/logger/analytics/tracking/WidgetTracking;

    move-result-object p1

    invoke-virtual {p0}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;->getAppWidgetMode()I

    move-result p0

    invoke-virtual {p1, p0}, Lcom/samsung/android/weather/logger/analytics/tracking/WidgetTracking;->sendWidgetDeleteEvent(I)V
...
.method public onDisabled(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onDisabled$1;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onDisabled$1;-><init>(Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;Lna/d;)V
...
.method public onEnabled(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onEnabled$1;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onEnabled$1;-><init>(Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;Lna/d;)V
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_1
    invoke-super {p0, p1, p2}, Lcom/sec/android/daemonapp/cover/provider/Hilt_AbsCoverAppWidgetProvider;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    new-instance v1, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onUpdate$1;

    const/4 v2, 0x0

    invoke-direct {v1, p3, p0, v2}, Lcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider$onUpdate$1;-><init>([ILcom/sec/android/daemonapp/cover/provider/AbsCoverAppWidgetProvider;Lna/d;)V
