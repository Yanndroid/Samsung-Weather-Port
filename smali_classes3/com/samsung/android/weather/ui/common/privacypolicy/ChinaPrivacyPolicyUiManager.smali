.class public final Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;
...
.method public constructor <init>(Landroid/app/Application;Lcom/samsung/android/weather/system/service/SystemService;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;->application:Landroid/app/Application;

    iput-object p2, p0, Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;->systemService:Lcom/samsung/android/weather/system/service/SystemService;
...
.method public getEulaAgreeBtnResId()I
    ...
    sget p0, Lcom/samsung/android/weather/ui/common/R$string;->always_agree:I
...
.method public getEulaContent()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;->application:Landroid/app/Application;

    sget v0, Lcom/samsung/android/weather/ui/common/R$string;->use_current_location_body_msg_chn:I

    invoke-virtual {p0, v0}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string v0, "application.getString(R.\u2026nt_location_body_msg_chn)"
...
.method public getEulaDisagreeBtnResId()I
    ...
    sget p0, Lcom/samsung/android/weather/ui/common/R$string;->disagree_txt:I
...
.method public getEulaLayout(Z)Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;->application:Landroid/app/Application;

    iget-object p0, p0, Lcom/samsung/android/weather/ui/common/privacypolicy/ChinaPrivacyPolicyUiManager;->systemService:Lcom/samsung/android/weather/system/service/SystemService;

    invoke-virtual {v0, v1, p0, p1}, Lcom/samsung/android/weather/ui/common/privacypolicy/PrivacyPolicyChinaLayoutGetter;->get(Landroid/app/Application;Lcom/samsung/android/weather/system/service/SystemService;Z)Landroid/view/View;
...
.method public getEulaTitle()Ljava/lang/String;
    ...
    sget v0, Lcom/samsung/android/weather/ui/common/R$string;->menu_current_city_show:I

    invoke-virtual {p0, v0}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string v0, "application.getString(R.\u2026g.menu_current_city_show)"
