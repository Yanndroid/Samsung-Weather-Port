.class public final Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;",
...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->application:Landroid/app/Application;
...
.method public getApplication()Landroid/app/Application;
    ...
    iget-object p0, p0, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->application:Landroid/app/Application;
...
.method public getLevel(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->getApplication()Landroid/app/Application;
    ...
    sget p1, Lcom/samsung/android/weather/ui/common/R$string;->index_state_extreme:I

    invoke-virtual {p0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string p1, "application.getString(R.\u2026ring.index_state_extreme)"
    ...
    const-string p1, "application.getString(R.\u2026ng.index_state_very_high)"
    ...
    const-string p1, "application.getString(R.string.index_state_high)"
    ...
    sget p1, Lcom/samsung/android/weather/ui/common/R$string;->index_state_uv_moderate:I

    invoke-virtual {p0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string p1, "application.getString(R.\u2026.index_state_uv_moderate)"
    ...
    const-string p1, "application.getString(R.string.index_state_low)"
...
.method public invoke(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->checkPreCondition(Lcom/samsung/android/weather/domain/entity/weather/Index;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->getEmpty(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->getEntity(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetWniUVNotation;->invoke(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
