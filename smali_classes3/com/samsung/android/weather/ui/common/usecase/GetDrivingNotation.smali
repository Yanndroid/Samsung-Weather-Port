.class public final Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;
...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->application:Landroid/app/Application;
...
.method public getApplication()Landroid/app/Application;
    ...
    iget-object p0, p0, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->application:Landroid/app/Application;
...
.method public getPhrase(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->getLevel(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
...
.method public getTitle(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->getApplication()Landroid/app/Application;

    move-result-object p0

    sget p1, Lcom/samsung/android/weather/ui/common/R$string;->life_index_driving_difficulty:I

    invoke-virtual {p0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string p1, "application.getString(R.\u2026index_driving_difficulty)"
...
.method public getValueUnit(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->getValue(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
...
.method public invoke(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->checkPreCondition(Lcom/samsung/android/weather/domain/entity/weather/Index;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->getEmpty(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/GetDrivingNotation;->getEntity(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
