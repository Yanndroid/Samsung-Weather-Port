.class public final Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;",
...
.method public constructor <init>(Landroid/app/Application;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->application:Landroid/app/Application;
...
.method public getApplication()Landroid/app/Application;
    ...
    iget-object p0, p0, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->application:Landroid/app/Application;
...
.method public getLevel(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->getApplication()Landroid/app/Application;
    ...
    const-string p1, "application.getString(R.string.index_state_good)"
    ...
    const-string p1, "application.getString(R.\u2026ndex_state_chn__moderate)"
    ...
    const-string p1, "application.getString(R.string.index_state_bad)"
    ...
    const-string p1, "application.getString(R.\u2026ing.index_state_very_bad)"
...
.method public getTitle(Lcom/samsung/android/weather/domain/entity/weather/Index;)Ljava/lang/String;
    ...
    sget p1, Lcom/samsung/android/weather/ui/common/R$string;->life_index_cai:I

    invoke-virtual {p0, p1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    const-string p1, "application.getString(R.string.life_index_cai)"
...
.method public invoke(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->checkPreCondition(Lcom/samsung/android/weather/domain/entity/weather/Index;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->getEmpty(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->getEntity(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/weather/ui/common/usecase/notation/GetAqiKorNotation;->invoke(Lcom/samsung/android/weather/domain/entity/weather/Index;)Lcom/samsung/android/weather/ui/common/model/IndexNotationEntity;
